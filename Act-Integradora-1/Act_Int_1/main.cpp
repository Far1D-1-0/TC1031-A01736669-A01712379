 ...
 * g++ -std=c++20 -Wall -Wextra -pedantic -Werror -c main.cpp -o main.o
 * g++ -std=c++20 -Wall -Wextra -pedantic -Werror -c src/DateToNum.cpp -o DateToNum.o
 * g++ -std=c++20 -Wall -Wextra -pedantic -Werror -c src/fileReader.cpp -o fileReader.o
 * g++ -std=c++20 -Wall -Wextra -pedantic -Werror -c src/LineRead.cpp -o LineRead.o
 * g++ -std=c++20 -Wall -Wextra -pedantic -Werror -c src/Registro.cpp -o Registro.o
 * g++ main.o DateToNum.o fileReader.o LineRead.o Registro.o -o Act_Int_1
 ...
 * Test 1: ./Act_Int_1 < TestCases/test01.txt
 * Test 2: ./Act_Int_1 < TestCases/test02.txt
 * Test 3: ./Act_Int_1 < TestCases/test03.txt
 * Test 4: ./Act_Int_1 < TestCases/test04.txt
 * Referencias:
