...
{
    infile.open(filename, std::ios::binary); //Abre el archivo en modo lectura
...
const LineRead& fileReader::clRead() //Devuelve la intacnia y ademas guarda la ultima linea que esta leida
{
    return lr;
}

LineRead& fileReader::lRead()
{
    return lr;
}
